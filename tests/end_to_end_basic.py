...
def basic_shelf_maximize_coefficient_sum():
    ...
    prob = OptimizationProblem(s1, a1, 1, None, OptimizationMode.MAXIMIZE_COEFFICIENT_SUM)
...
def basic_shelf_maximize_minimum_coefficient():
    ...
    prob = OptimizationProblem(s1, a1, 1, None, OptimizationMode.MAXIMIZE_MINIMUM_COEFFICIENT)
